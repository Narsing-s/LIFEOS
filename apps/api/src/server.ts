...
app.get('/health',async()=>({ok:true,service:'lifeos-api',version:'1.8.0'}));
...
app.get('/api/v1',async()=>({name:'LIFEOS API',version:'v1',capabilities:['auth','dashboard','search','documents','memories','tasks','assets','assistant','integrations','timeline','inbox','finance','notifications','automations','sync','sync-history','life-overview','account-export']}));
