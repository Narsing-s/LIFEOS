...
const styles = StyleSheet.create({ safe:{flex:1,backgroundColor:'#f4f6fa'}, page:{padding:20,gap:16}, auth:{flex:1,justifyContent:'center',padding:24}, logo:{fontSize:24,fontWeight:'800',letterSpacing:1,color:'#172033'}, title:{fontSize:30,fontWeight:'800',color:'#172033',marginTop:20}, heroTitle:{fontSize:25,fontWeight:'800',color:'#172033'}, sub:{color:'#6b7588',marginTop:5,lineHeight:20}, input:{backgroundColor:'#fff',borderRadius:14,padding:16,marginTop:12,color:'#172033',borderWidth:1,borderColor:'#e1e6ee'}, button:{backgroundColor:'#172033',padding:16,borderRadius:14,alignItems:'center',marginTop:14}, buttonText:{color:'#fff',fontWeight:'700'}, error:{color:'#b42318',marginTop:10}, errorBox:{backgroundColor:'#fff4f2',borderRadius:14,padding:14}, retry:{color:'#5067a8',fontWeight:'800',marginTop:8}, link:{color:'#5067a8',fontWeight:'700'}, hero:{backgroundColor:'#e9edff',borderRadius:20,padding:20}, refresh:{alignSelf:'flex-start',marginTop:14,backgroundColor:'#172033',paddingHorizontal:16,paddingVertical:10,borderRadius:10}, refreshText:{color:'#fff',fontWeight:'700'}, card:{backgroundColor:'#fff',borderRadius:18,padding:18}, cardTitle:{fontSize:18,fontWeight:'800',color:'#172033',marginBottom:10}, item:{paddingVertical:10,color:'#30394b',borderBottomWidth:1,borderBottomColor:'#edf0f4'}, empty:{color:'#8b95a7'} });
